...
const int simulation_wire_parts_count = 20000;

//field lines specific
const float step_size_lines = 0.005; //how dense the lines get rendered
//vector field specific
const int step_size_vector = 10; //how often there is a vector rendered


//loop specific, also for coils
const float radius = 0.04;
//specific for Coils, not implementet yet
const int coil_winding_count = 100; //has to be divident of simulation_wire_parts_count, also not working properly
